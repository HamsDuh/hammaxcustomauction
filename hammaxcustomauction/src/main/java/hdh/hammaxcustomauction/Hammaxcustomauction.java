...
public final class Hammaxcustomauction extends JavaPlugin {
    ...
    //25.4.  3h
    //26.4.  4h
    //27.4.  2h         ->98h Total     //abgeholt
    //29.4.  2h 15min                   //abgeholt


    //Bei gebot erstellen UI feder und item mittig setzen
    //groß klein schreibung
    //Debug bei seite aktuallisieren





    //trostkeks bei geboten über 100k       /bei gewinn Glückskeks              Lederstiefel        Trostschlapfen/

    //Trostschlapfen        §6
        //<Spieler> hat am <Datum>
        //Auf das item: <Item>          §3, §5
        //Einen Wert von <Menge> Geboten.
        //---------------------------------
        //Gewonnen hat <Spieler> leider nicht
    //oder
        //Damit hat <Spieler> auch gewonnen

    //Schuhe ins itemlager legen



    //admin spieler- gebotsliste
    ...
    /*to do
    -ALLE ITEMS in UI eigener Tag "ToBeDeleted" oder so
    -listener der bei item pickup alle TOBeDeleted löscht
            (Item pickup/itemMove

    view bauen (vorbedingungen)

    vault is enabled checken (falls nicht selbst plugin disablen

    Vault in dependencies
    */
